...
import com.steegler.exit.domain.repository.BasicRepository
...
//            .addMigrations(MIGRATION_1_2)
    ...
    fun provideLiveRepo(@ApplicationContext appContext: Context): RatesRepo {
        return BasicRepository(provideRateDao(appContext))
    }
    ...
    fun provideBusinessLogic(@ApplicationContext appContext: Context): BusinessLogic {
        val tempRepo = BasicRepository(provideRateDao(appContext))
